...
Since open channel flow there is a free surface between the water and the air (atmosphere), Froude number h<sub>Fr = U/&\sqrt(gL)</sub>. h<sub>&theta;</sub>(x) = &theta;<sub>o</sub> x + &theta;<sub>1</sub>x
If Froude number
